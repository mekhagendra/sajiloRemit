                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div className="w-9 h-9 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0">
                          {rate.remitter.logo
                            ? <img src={rate.remitter.logo} alt={rate.remitter.brandName || rate.remitter.legalName || ''} className="w-full h-full object-contain rounded-full p-0.5" onError={e => { e.currentTarget.style.display='none'; }} />
                            : <span className="text-green-700 font-bold text-xs">{(rate.remitter.brandName || rate.remitter.legalName || '?').charAt(0)}</span>
                          }
                        </div>
                        <div>
                          <span className="font-medium text-gray-900">{rate.remitter.brandName || rate.remitter.legalName || '—'}</span>
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-semibold text-gray-900">{rate.remitter.brandName || rate.remitter.legalName || '—'}</span>
                  </div>
