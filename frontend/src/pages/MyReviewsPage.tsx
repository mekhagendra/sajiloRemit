    ...
    <div className="max-w-3xl mx-auto px-4 py-10">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-3 mb-2">
                      {remitter?.logo && (
                        <img
                          src={remitter.logo}
                          alt={remitter.brandName || remitter.legalName}
                          className="w-8 h-8 rounded-full object-cover border border-gray-200"
                        />
                      )}
                      <span className="font-semibold text-gray-900">
                        {remitter?.brandName || remitter?.legalName || 'Deleted Remitter'}
                      </span>
                    </div>
      ...
      {editingReview && editingReview.remitterId && typeof editingReview.remitterId === 'object' && (
        <ReviewModal
          ...
          brandName={editingReview.remitterId.brandName || editingReview.remitterId.legalName}
